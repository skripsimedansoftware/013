	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu" data-widget="tree">
				...
				<li class="<?php echo $this->router->fetch_method() == 'freelancer_criteria'?'active':'' ?>"><a href="<?php echo base_url($this->router->fetch_class().'/freelancer_criteria') ?>"><i class="fa fa-users"></i> <span>Freelancer</span></a></li>
